...
export default [
      ...
      data: [
        {
          ...
          payAmount: 299.00,
          addressSnapshot: '{"receiver":"张三","phone":"13800138000","province":"四川","city":"成都","district":"武侯区","detail":"磨子桥1号"}',
          payType: 2,
          payTime: '2026-07-07 10:05:00',
          remark: '',
          createTime: '2026-07-07 10:00:00',
          items: [
            { id: 1, productId: 1, skuId: 101, productName: 'Mock 商品 A', productImage: 'https://via.placeholder.com/200', price: 99.00, quantity: 2, isGift: 0 },
          ],
        },
      ],
    }),
  },
  {
    ...
    response: () => ({
      ...
      message: 'success',
      data: [
        { orderId: 1, orderNo: '20260706153000000001', shopId: 1, payAmount: 299.00, freightAmount: 10.00, promotionDiscountAmount: 0, couponDiscountAmount: 0, pointsDeductAmount: 0 },
      ],
    }),
  },
  {
      ...
      data: [
        {
          ...
          createTime: '2026-07-07 10:00:00',
          items: [
            { id: 1, productName: 'Mock 商品 A', price: 99.00, quantity: 2, isGift: 0 },
          ],
        },
      ],
    }),
  ...
  },
  {
    ...
    response: () => ({
      ...
      message: 'success',
      data: [
        { id: 1, name: '新人专享券', type: 1, discount: 20, minAmount: 50, validFrom: '2026-07-01', validTo: '2026-07-31', status: 1 },
      ],
    }),
  },
  {
    ...
    response: () => ({
      ...
      message: 'success',
      data: [
        { id: 1, name: '夏日特惠', type: 1, ruleJson: '{"discountPercent":0.8}', scope: 'SHOP', scopeId: 1, startTime: '2026-07-01 00:00:00', endTime: '2026-07-31 23:59:59' },
      ],
    }),
  },
]
