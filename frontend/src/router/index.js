...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'order/batch-pay', name: 'OrderBatchPay', component: () => import('@/views/consumer/order/BatchPay.vue'), meta: { requiresAuth: true } },
      { path: 'orders', name: 'OrderList', component: () => import('@/views/consumer/order/List.vue'), meta: { requiresAuth: true } },
      { path: 'orders/:id', name: 'OrderDetail', component: () => import('@/views/consumer/order/Detail.vue'), meta: { requiresAuth: true } },
