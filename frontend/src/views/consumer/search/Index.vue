<template>
  <div class="search-page">
    ...
    <div class="search-filters" style="margin-top: 15px;">
      ...
      <el-input-number v-model="minPrice" :min="0" :precision="2" :controls="false" placeholder="最低价" style="width: 110px;" />
      <span style="margin: 0 6px; color: #999;">—</span>
      <el-input-number v-model="maxPrice" :min="0" :precision="2" :controls="false" placeholder="最高价" style="width: 110px;" />
